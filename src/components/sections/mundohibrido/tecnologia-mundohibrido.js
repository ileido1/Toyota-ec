...
const MundoHibridoTecnologia = () => (
    ...
    <div id="tecnologia-mundo-hibrido" className="tecnologia-mundo-hibrido container-fluid d-none d-sm-none d-md-block d-xl-block d-lg-block col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 titulo-galeria sinpadding" >
        
        <div className="col-12"  >
            <p class="text-color-diseno2 secciones-subtitulos">TECNOLOGÍA HÍBRIDA</p>
