...
export default function VideoliderMundoHibrido() {
    ...
    return (
        <>
        <div id="garantia-mundo-hibrido" className="tecnologia-mundo-hibrido container-fluid d-block d-block d-md-block d-xl-block d-lg-block col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 titulo-galeria sinpadding" >
