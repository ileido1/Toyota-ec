...
const Cartgaleriapestanainterior = () => { 
    ...
    if(detalle_respuesta){
        let fotos_array = detalle_respuesta[0]['interior_galeria_vehiculo']       
...
export default Cartgaleriapestanainterior;